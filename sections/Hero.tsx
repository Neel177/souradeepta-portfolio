...
import { fadeIn, fadeUp, scaleIn, staggerContainer, viewportOnce } from "@/lib/animations";
...
export function Hero() {
    ...
    return (
        <section
            id="top"
            className="relative overflow-x-clip px-5 pb-16 pt-28 sm:pb-20 sm:pt-36 lg:px-10 lg:pb-24 lg:pt-44"
        >
            ...
            <div className="relative mx-auto w-full min-w-0 max-w-6xl">
                ...
                >
                            ...
                            <div className="relative h-full w-full overflow-hidden rounded-full border-2 border-[var(--color-surface)] bg-[var(--color-surface-2)]">
                                ...
                                {photoMissing && (
                                    <div className="absolute inset-0 flex items-center justify-center bg-[var(--color-surface-2)]">
                                        <span className="font-mono text-[8px] uppercase tracking-widest text-muted">SD</span>
                                    </div>
                                )}
                            </div>
                        </div>
                    ...
                    >
                        ...
                        <span className="bg-gradient-signature bg-clip-text text-transparent">Full-Stack</span>
                        <br />
                    ...
                    <motion.div variants={fadeUp} className="mt-7 flex flex-wrap items-center gap-3">
                        ...
                        <GradientButton
                            ...
                            variant="ghost"
                            className="border border-[var(--color-border-strong)] px-5 py-3 text-sm text-muted hover:border-[var(--color-border-strong)] hover:bg-[var(--color-surface-2)] hover:text-ink"
                        >
                            View resume
                ...
                <div className="hidden min-h-[36rem] items-start gap-16 lg:grid lg:grid-cols-[1fr_auto] xl:gap-20">
                    ...
                    >
                        ...
                        >
                            ...
                            Science
                            <br />
                            <span className="text-ink/50">Educator &</span>
                            <br />
                        ...
                        <motion.div variants={fadeUp} className="mt-9 flex flex-wrap items-center gap-3">
                            ...
                            <GradientButton
                                href={profile.resumeFile}
                                variant="ghost"
                                className="border border-[var(--color-border-strong)] px-6 py-3.5 text-sm text-muted hover:bg-[var(--color-surface-2)] hover:text-ink"
                            >
                                View resume
                                ...
                                <div className="absolute inset-0 rounded-full bg-[conic-gradient(from_180deg,var(--color-violet),var(--color-cyan),var(--color-emerald),var(--color-violet))] p-[3px]">
                                    ...
                                    <div className="h-full w-full rounded-full bg-[var(--color-void)] p-[6px]">
                                        ...
                                        <div className="relative h-full w-full overflow-hidden rounded-full bg-[var(--color-surface-2)]">
                                            ...
                                            {/* Bottom info */}
                                            <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-[var(--color-void)]/90 via-[var(--color-void)]/30 to-transparent px-7 pb-7 pt-16">
                ...
                >
                    {profile.stats.map((stat) => (
                        <div key={stat.label} className="group px-5 py-6 transition-colors hover:bg-[var(--color-surface)] first:pl-0 last:pr-0 sm:px-7">
